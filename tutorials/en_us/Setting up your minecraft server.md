...
If you want to start the server and want to be able to exit out of the terminal without the server closing, you can use an in-built linux utility called [tmux](https://github.com/tmux/tmux/wiki)
